#!/bin/bash
# Netzwerk- und Performance-Testskript mit TCPDump, sysbench und redis-benchmark
...
# 2️⃣ MariaDB Performance-Test mit sysbench
...
# 3️⃣ Redis-Cache-Test mit redis-benchmark
...
# 4️⃣ Einzelne Redis-Zugriffe testen
