...
running (0m04.0s), 10/10 VUs, 10 complete and 0 interrupted iterations
default   [  13% ] 10 VUs  04.0s/30s

running (0m05.0s), 10/10 VUs, 10 complete and 0 interrupted iterations
default   [  17% ] 10 VUs  05.0s/30s

running (0m06.0s), 10/10 VUs, 10 complete and 0 interrupted iterations
default   [  20% ] 10 VUs  06.0s/30s

running (0m07.0s), 10/10 VUs, 20 complete and 0 interrupted iterations
default   [  23% ] 10 VUs  07.0s/30s

running (0m08.0s), 10/10 VUs, 20 complete and 0 interrupted iterations
...
running (0m11.0s), 10/10 VUs, 30 complete and 0 interrupted iterations
default   [  37% ] 10 VUs  11.0s/30s

running (0m12.0s), 10/10 VUs, 30 complete and 0 interrupted iterations
default   [  40% ] 10 VUs  12.0s/30s

running (0m13.0s), 10/10 VUs, 40 complete and 0 interrupted iterations
default   [  43% ] 10 VUs  13.0s/30s

running (0m14.0s), 10/10 VUs, 40 complete and 0 interrupted iterations
default   [  47% ] 10 VUs  14.0s/30s

running (0m15.0s), 10/10 VUs, 40 complete and 0 interrupted iterations
default   [  50% ] 10 VUs  15.0s/30s

running (0m16.0s), 10/10 VUs, 50 complete and 0 interrupted iterations
default   [  53% ] 10 VUs  16.0s/30s

running (0m17.0s), 10/10 VUs, 50 complete and 0 interrupted iterations
default   [  57% ] 10 VUs  17.0s/30s

running (0m18.0s), 10/10 VUs, 50 complete and 0 interrupted iterations
default   [  60% ] 10 VUs  18.0s/30s

running (0m19.0s), 10/10 VUs, 60 complete and 0 interrupted iterations
default   [  63% ] 10 VUs  19.0s/30s

running (0m20.0s), 10/10 VUs, 60 complete and 0 interrupted iterations
default   [  67% ] 10 VUs  20.0s/30s

running (0m21.0s), 10/10 VUs, 60 complete and 0 interrupted iterations
default   [  70% ] 10 VUs  21.0s/30s

running (0m22.0s), 10/10 VUs, 70 complete and 0 interrupted iterations
default   [  73% ] 10 VUs  22.0s/30s

running (0m23.0s), 10/10 VUs, 70 complete and 0 interrupted iterations
default   [  77% ] 10 VUs  23.0s/30s

running (0m24.0s), 10/10 VUs, 70 complete and 0 interrupted iterations
default   [  80% ] 10 VUs  24.0s/30s

running (0m25.0s), 10/10 VUs, 80 complete and 0 interrupted iterations
default   [  83% ] 10 VUs  25.0s/30s

running (0m26.0s), 10/10 VUs, 80 complete and 0 interrupted iterations
default   [  87% ] 10 VUs  26.0s/30s

running (0m30.6s), 10/10 VUs, 80 complete and 0 interrupted iterations
default   [  90% ] 10 VUs  27.0s/30s

running (0m31.6s), 10/10 VUs, 90 complete and 0 interrupted iterations
default   [  93% ] 10 VUs  28.0s/30s

running (0m32.6s), 10/10 VUs, 90 complete and 0 interrupted iterations
default   [  97% ] 10 VUs  29.0s/30s

running (0m33.6s), 10/10 VUs, 90 complete and 0 interrupted iterations
default   [ 100% ] 10 VUs  30.0s/30s
     ...
     data_received..................: 413 kB  12 kB/s
     data_sent......................: 56 kB   1.7 kB/s
     http_req_blocked...............: avg=64.02µs  min=1.26µs   med=5.53µs   max=10.75ms  p(90)=8.82µs   p(95)=11.43µs
     http_req_connecting............: avg=38.5µs   min=0s       med=0s       max=9.42ms   p(90)=0s       p(95)=0s
     http_req_duration..............: avg=2.72ms   min=395.19µs med=2.7ms    max=13.71ms  p(90)=5.36ms   p(95)=10.07ms
       { expected_response:true }...: avg=2.72ms   min=395.19µs med=2.7ms    max=13.71ms  p(90)=5.36ms   p(95)=10.07ms
     http_req_failed................: 0.00%   0 out of 400
     http_req_receiving.............: avg=113.57µs min=24.29µs  med=107.41µs max=663.93µs p(90)=151.26µs p(95)=183.26µs
     http_req_sending...............: avg=27.53µs  min=6.3µs    med=15.07µs  max=847.17µs p(90)=39.33µs  p(95)=58.39µs
     http_req_tls_handshaking.......: avg=0s       min=0s       med=0s       max=0s       p(90)=0s       p(95)=0s
     http_req_waiting...............: avg=2.57ms   min=350.64µs med=2.54ms   max=13.6ms   p(90)=5.15ms   p(95)=9.95ms
     http_reqs......................: 400     11.851076/s
     iteration_duration.............: avg=3.01s    min=3s       med=3.01s    max=3.03s    p(90)=3.02s    p(95)=3.02s
     iterations.....................: 100     2.962769/s
     vus............................: 10      min=10         max=10
     vus_max........................: 10      min=10         max=10


running (0m33.8s), 00/10 VUs, 100 complete and 0 interrupted iterations
default ✓ [ 100% ] 10 VUs  30s 


---
Bericht zur Performance-Analyse des Cache-Tests mit k6
Wir haben einen Cache-Lasttest durchgeführt, um zu prüfen, ob Daten richtig zwischengespeichert werden und wie sich das auf die Antwortzeiten auswirkt.

Testergebnisse im Überblick
✅ Erste GET-Anfrage erfolgreich (Status 200)
✅ Cached GET-Anfrage erfolgreich (Status 200)
✅ Keine Fehler, alle 400 Anfragen wurden erfolgreich verarbeitet!

✔ Gesamtzahl der HTTP-Anfragen: 400
✔ Durchschnittliche Antwortzeit: 2,72 ms
✔ Maximale Antwortzeit: 13,71 ms

Detaillierte Performance-Daten
🔹 Datenverkehr

Empfangene Daten: 413 kB (12 kB/s)
Gesendete Daten: 56 kB (1,7 kB/s)
🔹 Antwortzeiten

Durchschnittliche Antwortzeit: 2,72 ms
Maximale Antwortzeit: 13,71 ms
90% der Anfragen schneller als: 5,36 ms
95% der Anfragen schneller als: 10,07 ms
🔹 Anfragen & Durchsatz

Gesamte HTTP-Anfragen: 400
Anfragen pro Sekunde: 11,85/s
Gesamte Iterationen: 100 (2,96 Iterationen pro Sekunde)
Bewertung der Ergebnisse
✅ Cache funktioniert einwandfrei → Alle GET-Anfragen wurden erfolgreich aus dem Cache beantwortet
✅ Schnelle Antwortzeiten → Die meisten Anfragen wurden unter 5 ms beantwortet
✅ Keine HTTP-Fehler oder Verzögerungen → Alle 400 Anfragen waren stabil und zuverlässig

-Der Cache funktioniert, weil:

Antwortzeiten extrem niedrig & konstant sind (~2.72ms).
Keine Schwankungen in p(90) oder p(95).
http_req_failed: 0.00% zeigt keine fehlerhaften Anfragen.
Code prüft explizit auf X-Cache & cached_response.
